...
<section
  ...
  on:mousedown|self={() => ($showPreferences = false)}
>
    ...
    <ul>
      <li>
        <label class="checkbox">
          ...
          <p>
            Continue to next episode in episode list when current episode
            completes.
          </p>
        </label>
      </li>
      ...
      <li>
        <label class="days">
          ...
          <span> Days</span>
          <p>
            Displays episodes that have released with this number of days in
            Recent Episodes
          </p>
        </label>
      </li>
