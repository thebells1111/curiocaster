...
<div class="container">
	<ul>
		...
		<li
			class:active={$currentDesktopView === 'playList'}
			on:click={() => {
				$currentDesktopView = 'playList';
				$showSubscriptionShowNotes = false;
			}}
		>
			Queue
		...
		<li
			class:active={$currentDesktopView === 'featured'}
			on:click={() => {
				$currentDesktopView = 'featured';
				$showSubscriptionShowNotes = false;
			}}
		>
			Discover
		...
		<li
			class:active={$currentDesktopView === 'support'}
			on:click={() => {
				$currentDesktopView = 'support';
				$showSubscriptionShowNotes = false;
			}}
		>
			Support
