<script>
	import { userState, userStateDB, enableAutoplay, recentSettings } from '$/stores';
...
<ul>
	<li>
		<label class="checkbox">
			...
			<p>Continue to next episode in playlist or episode list when current episode completes.</p>
		</label>
	</li>
	<li>
		<label class="max-eps">
			<input type="number" on:blur={handleChangeMaxEps} bind:value={$recentSettings.maxEps} />
	...
	<li>
		<label class="days">
			<input type="number" on:blur={handleChangeDays} bind:value={$recentSettings.time} />
			<span> Days</span>
			<p>Displays episodes that have released with this number of days in Recent Episodes</p>
		</label>
	</li>
</ul>
